 ...
 * @param numsamples number of samples to generate
 */
static void jar_xm_generate_samples_16bit(jar_xm_context_t* ctx, short* output, size_t numsamples)
{
    float* musicBuffer = (float*)malloc((2*numsamples)*sizeof(float)); /* cast for C++ */
 ...
 * @param numsamples number of samples to generate
 */
static void jar_xm_generate_samples_8bit(jar_xm_context_t* ctx, char* output, size_t numsamples)
{
    float* musicBuffer = (float*)malloc((2*numsamples)*sizeof(float)); /* cast for C++ */
    jar_xm_generate_samples(ctx, musicBuffer, numsamples);
